...
def is_low_point(grid: list[list[int]], row_index: int, col_index: int) -> bool:
    ...
    if row_index == 0:
        if col_index == 0:
            return point_height < grid[row_index][col_index+1] and point_height < grid[row_index+1][col_index]
        if col_index == len(grid[0])-1:
            return point_height < grid[row_index][col_index-1] and point_height < grid[row_index+1][col_index]
        return point_height < grid[row_index][col_index-1] and point_height < grid[row_index+1][col_index] and point_height < grid[row_index][col_index+1]
    ...
    if col_index == 0:
        return point_height < grid[row_index-1][col_index] and point_height < grid[row_index][col_index+1] and point_height < grid[row_index+1][col_index]

    if col_index == len(grid[0])-1:
        return point_height < grid[row_index-1][col_index] and point_height < grid[row_index][col_index-1] and point_height < grid[row_index+1][col_index]

    return point_height < grid[row_index-1][col_index] and \
        point_height < grid[row_index][col_index-1] and \
        point_height < grid[row_index+1][col_index] and \
